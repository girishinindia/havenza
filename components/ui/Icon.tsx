import {
  ArrowLeft, ArrowRight, ArrowUp, ArrowUpRight, Award, Baby, Briefcase, Building2, Check, ChevronDown, ChevronRight,
...
const ICONS: Record<string, LucideIcon> = {
  ...
  tent: Tent, trees: Trees, truck: Truck, 'utensils-crossed': UtensilsCrossed, wind: Wind, x: X,
};
